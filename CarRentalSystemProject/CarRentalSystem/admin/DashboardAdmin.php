...
<body>
    ...
    <form method="POST" action="admin/offer.php">
    ...
    <table>
        <tr><th>Car</th><th>Discount</th><th>From</th><th>To</th><th>Action</th></tr>
        <?php
        $offers = mysqli_query($conn, "SELECT offers.*, cars.name, cars.model FROM offers 
                                       JOIN cars ON offers.car_id = cars.id");
        while ($offer = mysqli_fetch_assoc($offers)) {
            echo "<tr>
                    <td>{$offer['name']} ({$offer['model']})</td>
                    <td>{$offer['discount_percent']}%</td>
                    <td>{$offer['start_date']}</td>
                    <td>{$offer['end_date']}</td>
                    <td><a href='admin/delete_offer.php?id={$offer['id']}'>Delete</a></td>
                  </tr>";
        }
        ?>
    </table>
